...
Say there has been a SIEM alert. A security analyst has to use a playbook to respond. The first action is to _assess the alert_, i.e., to determine if the alert is actually valid by identifying why it was generated by the tool.
