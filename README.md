...
1. **Self-hosted SIEM tools**: They require organizations to install, operate and maintain the tool using their own physical infrastructure, such as server capacity. The organization's IT department manages and maintains these applications, rather that a third party vendor.
