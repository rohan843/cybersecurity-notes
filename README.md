...
3. **Defence in depth.** This principle requires that an organization should have multiple security controls that address risks and threats in different ways.
